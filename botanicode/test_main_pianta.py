...
plotter_grafo.plot(save_folder=folder, name=f"struttura_{0}")
plotter_struttura.plot(save_folder=folder, name=f"struttura_{0}")

# Simulation parameters
time_steps = 11 # Number of growth steps
...
plotter_history_methods = [lambda ax: my_plant.structure.history.plot_value(ax=ax,resource="elongation_rate", legend=True),
...
plotter_history.plot(save_folder=folder, name=f"track")
